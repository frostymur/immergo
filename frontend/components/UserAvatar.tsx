...
export default function UserAvatar() {
  ...
  if (!user) {
    return (
      <Link
        href="/auth"
        className="bg-primary hover:bg-primary-hover text-foreground px-4 py-2 text-sm font-medium transition-colors font-mono text-[11px] uppercase tracking-wider"
      >
        Sign in
      </Link>
    );
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 w-56 bg-surface border border-border p-2 z-50">
