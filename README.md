...
**AI-powered adaptive tutor for Kazakh schoolchildren**

Teaches any subject in **KZ / RU / EN** with real-time voice, math rendering, adaptive difficulty, and teacher analytics.
...
![SUPABASE](https://img.shields.io/badge/SUPABASE-PostgreSQL-3FCF8E?style=for-the-badge&labelColor=1a1a2e&logo=supabase&logoColor=white)
![TAILWIND](https://img.shields.io/badge/TAILWIND%20CSS-4-06B6D4?style=for-the-badge&labelColor=1a1a2e&logo=tailwindcss&logoColor=white)
...
[hyphypnotic/immergo](https://github.com/hyphypnotic/immergo)
...
- **Diagnostic Assessment** — a 15-question test per subject identifies weak topics and sets the difficulty baseline
...
- **Judge-Call** — a separate LLM evaluates student answers independently before the tutor responds, ensuring honest grading
...
- **🗣️ Clarify First** — asks what the student already knows before lecturing
...
- **⚖️ Fair Grading** — judge-call evaluates answers independently

All lesson content renders with **KaTeX** math (`$...$`), **Markdown** (tables, lists, bold), and structured blocks.

### ⚖️ Judge-Call — Independent Answer Verification
...
- **🗺️ Weak-Topic Heatmap** — visual heatmap of student weaknesses across topics
...
|-----------|---------|------|
| ![Next.js](https://img.shields.io/badge/Next.js-16-black?logo=next.js&logoColor=white) | 16 | React framework, App Router, Server Components |
| ![React](https://img.shields.io/badge/React-19-61DAFB?logo=react&logoColor=black) | 19 | UI component model |
| ![Tailwind CSS](https://img.shields.io/badge/Tailwind%20CSS-4-06B6D4?logo=tailwindcss&logoColor=white) | 4 | Utility-first styling, mobile-first responsive |
| KaTeX | — | Math formula rendering (`$...$` in lesson content) |
| ![Framer Motion](https://img.shields.io/badge/Framer%20Motion-latest-05F?logo=framer&logoColor=white) | latest | Animations and transitions |
| ![TypeScript](https://img.shields.io/badge/TypeScript-5-3178C6?logo=typescript&logoColor=white) | 5 | End-to-end type safety |

### ⚙️ Application Tier

| Technology | Version | Role |
|-----------|---------|------|
| ![FastAPI](https://img.shields.io/badge/FastAPI-0.129-009688?logo=fastapi&logoColor=white) | 0.129 | Async REST API, SSE streaming, auto-generated OpenAPI docs |
| edge-tts | — | Microsoft Azure TTS voices (KZ/RU/EN) — free, no API key |
| OpenAI SDK | — | LLM client (connects to `alemllm` and `llm.alem.ai` endpoints) |
| ![Langfuse](https://img.shields.io/badge/Langfuse-tracing-purple?logoColor=white) | — | LLM observability and tracing |

### 🗄️ Data Tier

| Technology | Version | Role |
|-----------|---------|------|
| ![Supabase](https://img.shields.io/badge/Supabase-PostgreSQL-3FCF8E?logo=supabase&logoColor=white) | 15 | Auth, Row-Level Security, Realtime, Storage |
...
# E2E — live backend + frontend running
node /tmp/e2e-*.mjs
```
...
3. **🗺️ Roadmap** — personalized topic path based on diagnostic results
4. **🖊️ Workspace** — AI tutor delivers adaptive lesson with KaTeX formulas, voice, quiz
5. **⚙️ Settings** — pick voice per language (KZ/RU/EN)
...
| Name | Role |
|------|------|
| [@timuriskakov](https://github.com/timuriskakov) | Backend, LLM integration, infrastructure, full-stack |
| [@aidonkee](https://github.com/aidonkee) | Frontend, UI/UX, marketing landing |
